...
const appendValue = (value) => {
  ...
  if (value === ".") {
    // Bolt Optimization: Replace regex split and array allocation with a simple backward loop.
    // This avoids creating temporary arrays and regex overhead on every decimal point press.
