...
const appendValue = (value) => {
  ...
  if (value === ".") {
    // Optimization: Check for existing decimal in current number via backward traversal
    // to avoid array allocation from string splitting (~20x faster in benchmarks).
