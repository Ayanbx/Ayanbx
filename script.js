...
const appendValue = (value) => {
  ...
  if (value === ".") {
    // Optimization: Search backwards for a decimal to prevent multiple decimals in one number,
    // stopping if an operator is found. This avoids expensive regex splits and array allocations.
